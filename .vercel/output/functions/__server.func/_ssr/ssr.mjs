...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-p1D6igkK.mjs");
...
var manifest = {
	"4f770c30bfcf4b5ebc36bebfbedefcee6cb0d6b6b396debf85ee95f3fdc893bc": {
		functionName: "getMarketSnapshot_createServerFn_handler",
		importer: () => import("./server-N5Z5yTGC.mjs")
	},
	"af7b8afae18a1f384c132e43faab98d0bfcdd661acd1167a6b841017125368ab": {
		functionName: "getExpiryChain_createServerFn_handler",
		importer: () => import("./server-N5Z5yTGC.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B4IgsJID.mjs").then((n) => n.t),
